...
def prompt_full(interactive: bool) -> Generator[Message, None, None]:
    ...
    yield from prompt_shade(interactive)
...
def prompt_shade(interactive: bool) -> Generator[Message, None, None]:
    """
    Base system prompt for shade.

    It should:
     - Introduce shade and its general capabilities and purpose
    ...
    base_prompt = f"""
You are shade v{__version__}, a general-purpose AI assistant powered by LLMs.
...
document_prompt_function(interactive=True)(prompt_shade)
