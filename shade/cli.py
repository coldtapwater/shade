...
docstring = f"""
shade is a chat-CLI for LLMs, empowering them with tools to run shell commands, execute code, read and manipulate files, and more.
...
def main(
    ...
    if version:
        # print version
        print(f"shade {importlib.metadata.version('shade')}")
